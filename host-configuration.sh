...
## apt
sudo apt update
sudo apt install openssh-server curl wget ethtool net-tools autoconf msmtp-mta mailutils clamav clamav-daemon build-essential coreutils htop ncdu python3 rsync unattended-upgrades apt-listchanges apt-transport-https ca-certificates software-properties-common
